  ...
  return (
    <div className="flex flex-row items-center w-5/6 xl:w-7/12 pt-8 md:pt-16 justify-center">
      ...
      <div className='flex flex-col items-center '>
        ...
        <form action="" className='flex flex-col items-center w-5/6 gap-4 sm:gap-7 mt-4'>
            <input type="text"  className=' outline-none text-xs md:text-base w-full sm:w-5/6 md:w-full  rounded-none py-1 pl-1 sm:py-3 sm:pl-3' placeholder='michael@ymail.com' style={{boxShadow:'0px 3.02px 3.15px 0px rgba(0, 0, 0, 0.01),0px 13.28px 6.52px 0px rgba(0, 0, 0, 0.02),0px 32.6px 13px 0px rgba(0, 0, 0, 0.02),0px 62.79px 25.48px 0px rgba(0, 0, 0, 0.02),0px 105.65px 46.85px 0px rgba(0, 0, 0, 0.03),0px 163px 80px 0px rgba(0, 0, 0, 0.04)'}}/>
