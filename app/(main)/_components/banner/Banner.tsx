    ...
    <div className="w-5/6 xl:w-7/12 flex flex-col">
      <div className="flex flex-row justify-center gap-5 sm:gap-0 items-center sm:items-stretch sm:justify-between">
        ...
        <div className="flex flex-col justify-between">
            ...
            <Image className="xl:w-48" src="/home/banner/ultimate.png"  width={150} height={20} alt="" />
            ...
            <Image className=" hidden sm:inline-block rounded-md w-40 md:w-44 lg:w-56 xl:w-60" src="/home/banner/girls2.png" width={300} height={20} alt="" />
        </div>
